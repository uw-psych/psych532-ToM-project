...
```{r}
tom2 <- read.csv("~/UW/LCD Lab - Documents/Studies/Perspective Taking/Theory of Mind/Sotomayor et al ToM Open Dataset/Gender Differences/ToMBooklet2-Data.csv")
gender <- read.csv("~/UW/LCD Lab - Documents/Studies/Perspective Taking/Theory of Mind/Sotomayor et al ToM Open Dataset/Gender Differences/Gender.csv") %>%
  rename(subID = SubID)
```
